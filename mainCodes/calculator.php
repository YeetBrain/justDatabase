...
<body>
    ...
    <div class="identifier">
        ...
        <!--<button onclick="savePDF()" style="font-size: 20px; padding: 10px 20px; border: 2px solid #024fd4; border-radius: 5px; background-color: #060c31; color: white;">Save PDF Report</button>-->
                ...
                <div class="semester" id="semester1">
                    ...
                    <table id="semester1Table">
                        ...
                        <tr>
                            ...
                            <td><button onclick="addCourse('semester1')">Add Course</button></td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <script>
            ...
            newSemester.innerHTML = `
                ...
                <table id="semester${semesterCount}Table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="courseName" required></td>
                        <td><input type="number" min="0" max="4" step="0.5" class="credit" required /></td>
                        <td><button onclick="addCourse('semester${semesterCount}')">Add Course</button></td>
                    </tr>
                </table>
            `;
        ...
        function generatePDF() {
            ...
            const doc = new jsPDF();
            pdfContent += 'GPA Calculator Report\n\n';
    ...
    formData.append('pdf', pdfBlob, 'GPA_Calculator_Report.pdf');
